...
func (s *backupsSuite) TestRequiresAuth(c *gc.C) {
	resp := sendHTTPRequest(c, httpRequestParams{method: "GET", url: s.backupURL})
...
func (s *backupsSuite) checkInvalidMethod(c *gc.C, method, url string) {
	resp := s.sendHTTPRequest(c, httpRequestParams{method: method, url: url})
...
func (s *backupsSuite) TestAuthRequiresClientNotMachine(c *gc.C) {
	...
	resp = s.sendHTTPRequest(c, httpRequestParams{method: "POST", url: s.backupURL})
...
func (s *backupsUploadSuite) sendValid(c *gc.C, id string) *http.Response {
	...
	return s.sendHTTPRequest(c, httpRequestParams{method: "PUT", url: s.backupURL, contentType: ctype, body: &parts})
}
