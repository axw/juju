...
const (
	...
	// interactive authentication. When the user logs in, a service
...
func createOrUpdateServicePrincipal(
	...
	passwordCredential, err := preparePasswordCredential(newUUID)
	if err != nil {
...
func preparePasswordCredential(newUUID func() (utils.UUID, error)) (ad.PasswordCredential, error) {
	...
	return ad.PasswordCredential{
		// TODO(axw) include the credential name?
...
func addServicePrincipalPasswordCredential(
	...
	if _, err := client.UpdatePasswordCredentials(
		servicePrincipalObjectId,
