...
func prepare(
	...
	cfg, err = p.BootstrapConfig(environs.BootstrapConfigParams{
		args.ControllerConfig.UUID, cfg, args.Credential, args.CloudRegion,
	...
	details.CACert = args.ControllerConfig.CACert
	details.ControllerUUID = args.ControllerConfig.UUID
