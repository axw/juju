...
// DestroyUnitOperation is a transaction operation for destroying a unit.
...
// Build is part of the TransactionOperation interface.
...
// Committed is part of the TransactionOperation interface.
